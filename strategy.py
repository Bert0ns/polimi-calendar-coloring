        ...
        if title.startswith("Esame: "):
            if self.interactive:
                ...
                if title in self.subscribed_titles:
                    print(f"Auto-declining '{title}' on {date_str} because you are already subscribed to another date.")
                ...
                while True:
                    ...
                    if ans in ['y', 'yes']:
                        ...
                        print("Please answer 'y' or 'n'. If there is a suggestion, you can press Enter to accept it.")
                return self.decision_cache[cache_key]
            else:
                if description.startswith("Non iscritto"):
                    return self.COLOR_GREY
